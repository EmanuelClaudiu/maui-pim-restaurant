...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"f75e1e57-3e4d-4bb7-b734-b403af8ac5bb\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [34 x i8] c"com.companyname.maui_app_tutorial\00", align 16
...
@__DSOCacheEntry_name.79 = internal constant [32 x i8] c"libaot-MAUI App Tutorial.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [476 x %struct.DSOCacheEntry] [
	...
	; 224
	%struct.DSOCacheEntry {
		i64 9086104712280090740, ; hash 0x7e18541877752874, from name: aot-MAUI App Tutorial.dll.so
		i8 0, ; ignore
	...
	; 226
	%struct.DSOCacheEntry {
		i64 9123449344838722309, ; hash 0x7e9d00d74d61e305, from name: MAUI App Tutorial.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.79, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 292
	%struct.DSOCacheEntry {
		i64 11592227136091530985, ; hash 0xa0dfdd297a6126e9, from name: MAUI App Tutorial
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.79, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 446
	%struct.DSOCacheEntry {
		i64 17525499732976550882, ; hash 0xf33715272f4543e2, from name: aot-MAUI App Tutorial
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.79, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 456
	%struct.DSOCacheEntry {
		i64 18007624435420144713, ; hash 0xf9e7ef03f9dca449, from name: libaot-MAUI App Tutorial
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.79, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 465
	%struct.DSOCacheEntry {
		i64 18174231150366336700, ; hash 0xfc37d6f0a76ca6bc, from name: libaot-MAUI App Tutorial.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.79, i32 0, i32 0), ; name
		i8* null; handle
	}, 
